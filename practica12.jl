...
function grahamscan(A)
    ...
    P = collect(n) # список номеров точек
    for i in 2:n # первый шаг алгоритма заключается в том, чтобы первой точкой в P оказалась точка с наименьшей x-координатой
        if A[P[i]][1]<A[P[1]][1] # если P[i]-ая точка лежит левее P[0]-ой точки
...
#=Задача 3. Написать функцию, получающую на вход вектор кортежей с координатами вершин некоторого плоского многоугольника, 
перечисленных в каком-то определенном, положительном или в отрицательном, направлении их обхода, и возвращающую значение его площади. 
Реализовать метод трапеций.=#

#=Задача 4. Написать функцию, получающую на вход вектор кортежей с координатами вершин некоторого плоского многоугольника, 
перечисленных в каком-то определенном, положительном или в отрицательном, направлении их обхода, и возвращающую значение его площади. 
Реализовать метод треугольников.=#
